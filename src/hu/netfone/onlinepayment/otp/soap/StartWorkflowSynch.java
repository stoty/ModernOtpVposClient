...
public class StartWorkflowSynch extends MWOperation {
	...
	public WorkflowState call(String templateName, String innerXML, TrafficLogger trafficLogger) throws SOAPException, UnsupportedEncodingException, ParserConfigurationException, SAXException, IOException, ParseException {
	...
	private static WorkflowState parseResponse(SOAPMessage responseMessage) throws ParserConfigurationException, UnsupportedEncodingException, SAXException, IOException, ParseException, SOAPException{
